...
- [pixi](https://pixi.sh) as the project and package manager for reproducible environments and task execution.
- [pre-commit](https://pre-commit.com) to manage multi-language pre-commit hooks, including: [ruff](https://github.com/astral-sh/ruff) to format and lint Python files (`.py`) and Jupyter Notebooks (`.ipynb`), [nbstripout](https://github.com/kynan/nbstripout) to manage notebook outputs, and [snakefmt](https://github.com/snakemake/snakefmt) to format Snakefiles and more.

## Requirements to use the cookiecutter template:

- Python 3.8+
- [cookiecutter](http://cookiecutter.readthedocs.org), which can be installed with `pip` (see [the official installation instructions](https://cookiecutter.readthedocs.org/en/latest/installation.html)).
- [pixi](https://pixi.sh/latest/installation), which manages the generated project's environment and tooling.
